...
with Simulation("./BRC_6hr0.5in_0.2mgL.inp") as sim:
...
ax[2,0].plot(valve_setting, ':', color='#818282', linewidth=2, label="Valve Setting")
ax[2,0].set_xticks([])
...
#ax[3,0].set_xticks([0,7373,14747,22120,29494,36867,44241])
#ax[3,0].set_xticklabels(["0","6","12","18","24","30","36"])
...
ax[1,1].plot(infil_tpC, color='#695580', linewidth=2, label='RTC')
ax[1,1].plot(infil_tp, '-.', color='#6CC6D1', linewidth=2, label='Standard')
ax[1,1].plot(infil_tpA, '--', color='#3B4D7A', linewidth=2, label='Amended')
ax[1,1].set_ylabel("Soil/Drain Conc (mg/L)")
ax[1,1].set_xticks([])

ax[2,1].plot(drain_loadC, color='#695580', linewidth=2, label='RTC')
ax[2,1].plot(drain_load, '-.', color='#6CC6D1', linewidth=2, label='Standard')
ax[2,1].plot(drain_loadA, '--', color='#3B4D7A', linewidth=2, label='Amended')
ax[2,1].set_ylabel("Drain Load (g)")
ax[2,1].set_xticks([])

ax[3,1].plot(exfil_loadC, color='#695580', linewidth=2, label='RTC')
ax[3,1].plot(exfil_load, '-.', color='#6CC6D1', linewidth=2, label='Standard')
ax[3,1].plot(exfil_loadA, '--', color='#3B4D7A', linewidth=2, label='Amended')
ax[3,1].set_ylabel("Caputed Load (g)")
#ax[3,1].set_xticks([0,7373,14747,22120,29494,36867,44241])
#ax[3,1].set_xticklabels(["0","6","12","18","24","30","36"])
ax[3,1].set_xlabel("Time (hours)")
plt.show()
